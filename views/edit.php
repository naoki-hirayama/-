...
<body>
    ...
    <!-- ここまで -->
        <form action="edit.php" method="post" entype="multipart/form-data">
            <p>ログインID：</p>
            <input type="text" name="login_id" value="<?php echo $user['login_id'] ?>">
            <p>名前：</p>
            ...
            <p>一言コメント：</p>
            <input type="text" name="comment" value="<?php echo $user['comment'] ?>"><br />
